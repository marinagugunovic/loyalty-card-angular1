...
Naloga 4:from influxdb import InfluxDBClient
...
# OBVEZNO uporabi svoje ime, da je baza unikatna
database_name = "katarina_sensor_data"

client.create_database(database_name)
client.switch_database(database_name)

a) Branje datoteke in upload v InfluxDB:
...
with open("sensor data.txt", "r", encoding="utf-8") as f:
    for line in f:
        ...
        kanal1, kanal2, kanal3, cas_meritve, sensorID = line.split(",")
...
print("Meritve so uspešno naložene.")
...
FROM meritve
WHERE 
(sensorID = 'Sensor1' AND kanal1 > 0)
OR
(sensorID = 'Sensor3' AND kanal1 < 0)
"""
